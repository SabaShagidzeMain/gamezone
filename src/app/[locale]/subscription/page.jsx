    ...
    <>
      ...
      <div className="text-[var(--text-color)] flex justify-center items-center m-4 p-4 flex-col gap-8">
        ...
        <div className="flex gap-8">
          <div className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">
            ...
            <p className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">
          ...
          <div className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">
            ...
            <p className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">Always Fresh Content</p>
            <p className="text-[0.8rem]">
        ...
        <div className="flex gap-8">
          <div className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">
            ...
            <p className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">Exclusive Community Access</p>
            <p className="text-[0.8rem]">
          ...
          <div className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">
            ...
            <p className="text-[var(--text-color)] w-80 text-center flex flex-col gap-[0.8rem] justify-center items-center">No Lock-In Contracts</p>
            <p className="text-[0.8rem]">
